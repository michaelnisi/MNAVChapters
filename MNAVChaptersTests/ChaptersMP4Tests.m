...
@implementation ChaptersMP4Tests
...
- (void)setUp {
    ...
    NSString *path = [bundle pathForResource:@"auphonic_chapters_demo" ofType:@"m4a"];
    NSURL *url = [NSURL fileURLWithPath:path];
    AVAsset *asset = [AVURLAsset assetWithURL:url];
    MNAVChapterReaderMP4 *parser = [MNAVChapterReaderMP4 new];
